...
public class Main {
   ...
   public static void main(String []args) throws IOException{
      // Create File, Scanner, and Strin[] OBJECTS 
      ...
      int i = 0; 
      // loop through every lines in the File using Scanner methods 
      // Loop while Scanner can still find another line in the File AND out line counter is less than 10 
